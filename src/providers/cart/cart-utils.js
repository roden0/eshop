...
export const getItemCount = (cartItems) => cartItems.reduce((totalItems, item) => totalItems + item.quantity ,0);

export const getTotalPrice = (cartItems) => cartItems.reduce((totalPrice,item)=> totalPrice + (item.price * item.quantity), 0)